    ...
    show : function (message) {
        if(this.activate) {
            if(this.activateStrict) {
                if(message.getMode() === this.strictMode) {
                    console.log("%c" + message.getMessage);
                }
            }
            else {
...
// console.log("Init %cHUD", "color: orange");
// console.log("Init %cHUD", "color: orange; font-style: bold");
//
